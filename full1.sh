...
# for weights
PYTHONPATH='.' python plenoxels/main.py --device 0 --config-path plenoxels/configs/final/samsung2024/room1_hybrid.py data_downsample=2 pose_npy_suffix=colmap use_intrinsic=True expname=room1_colmap selection=[[1,3,7,9],[5]]
PYTHONPATH='.' python plenoxels/main.py --device 0 --config-path plenoxels/configs/final/samsung2024/room1_hybrid.py data_downsample=2 pose_npy_suffix=sparf use_intrinsic=True expname=room1_colmap selection=[[1,3,7,9],[5]]
PYTHONPATH='.' python plenoxels/main.py --device 0 --config-path plenoxels/configs/final/samsung2024/room1_hybrid.py data_downsample=2 pose_npy_suffix=gt use_intrinsic=True expname=room1_colmap selection=[[1,3,7,9],[5]]
