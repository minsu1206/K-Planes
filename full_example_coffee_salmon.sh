...
# CUDA_VISIBLE_DEVICES=1 PYTHONPATH='.' python plenoxels/main.py --device 0 --config-path ${config_path} expname=$expname num_steps=1 data_downsample=4 selection=[[1,4,6,9],[0]] # cut roasted beef

# # train
# PYTHONPATH='.' python plenoxels/main.py --device 0 --config-path ${config_path} expname=$expname data_downsample=2 selection=[[1,4,6,9],[0]]
